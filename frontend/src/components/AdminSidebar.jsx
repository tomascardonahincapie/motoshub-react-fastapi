...
export const SECCIONES = [
  ...
  },
  {
    ...
    icono: (
      <Icono>
        <path d="M2.5 3h1.6l1.5 7.8a1.3 1.3 0 0 0 1.3 1h6.2a1.3 1.3 0 0 0 1.3-1l1-5.2H5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  ...
  },
  {
    ...
    icono: (
      <Icono>
        <path d="M4.5 2.5h11v15l-2-1.3-1.8 1.3-1.7-1.3-1.8 1.3-1.8-1.3-1.9 1.3z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
        <path d="M7.2 6.5h5.6M7.2 9.5h5.6M7.2 12.5h3.4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </Icono>
    ),
  },
  {
    ...
    icono: (
      <Icono>
        <path d="M11.5 2.5H5.5a1 1 0 0 0-1 1v13a1 1 0 0 0 1 1h9a1 1 0 0 0 1-1V6.5z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
        <path d="M11.5 2.5v4h4M7.5 11.5h5M7.5 14h3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </Icono>
    ),
  },
  {
    ...
    icono: (
      <Icono>
        <path d="M17 9.6a6.7 6.7 0 0 1-7.2 6.7 7.2 7.2 0 0 1-2.3-.3L4 17.5l1.3-3.1A6.5 6.5 0 0 1 3 9.6 6.7 6.7 0 0 1 10 3a6.7 6.7 0 0 1 7 6.6Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
        <path d="M8.3 8.1a1.7 1.7 0 0 1 3.3.6c0 1.1-1.6 1.4-1.6 2.3" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
...
export default function AdminSidebar({ seccion, setSeccion, abiertaEnMovil, cerrarEnMovil }) {
  return (
    <>
      ...
      {/* En escritorio la barra se queda fija mientras el contenido se
          desplaza: si no, al bajar hasta los gráficos el menú desaparece. */}
      <aside
