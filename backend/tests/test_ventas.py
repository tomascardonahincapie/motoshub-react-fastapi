...
# Datos de la semilla: moto 480.000 y cambio de aceite 70.000, IVA del 19 %.
PRECIO_MOTO = 480000
PRECIO_ACEITE = 70000
...
def test_sin_token_no_se_puede_vender(cliente_http):
    respuesta = cliente_http.post('/api/ventas', json={'items': [MOTO]})
