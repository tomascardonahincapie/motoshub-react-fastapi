...
UPDATE productos SET imagen = '/img/productos/ducati-monster937.webp'  WHERE nombre = 'Ducati Monster 937';
UPDATE productos SET imagen = '/img/productos/bmw-g310r.webp'          WHERE nombre = 'BMW G 310 R';
UPDATE productos SET imagen = '/img/productos/casco-integral.jpg'      WHERE nombre = 'Casco Integral MT Thunder';
UPDATE productos SET imagen = '/img/productos/casco-modular.jpg'       WHERE nombre = 'Casco Modular LS2 Valiant';
UPDATE productos SET imagen = '/img/productos/chaqueta-adventure.jpg'  WHERE nombre = 'Chaqueta Adventure Impermeable';
UPDATE productos SET imagen = '/img/productos/guantes-racing.jpg'      WHERE nombre = 'Guantes de Cuero Racing';
UPDATE productos SET imagen = '/img/productos/maleta-lateral.jpg'      WHERE nombre = 'Maleta Lateral Rígida 30L';
UPDATE productos SET imagen = '/img/productos/aceite-motor.jpg'        WHERE nombre = 'Aceite Motul 5100 10W40';
UPDATE productos SET imagen = '/img/productos/pastillas-freno.jpg'     WHERE nombre = 'Kit de Pastillas de Freno';
UPDATE productos SET imagen = '/img/productos/cadena-transmision.jpg'  WHERE nombre = 'Cadena de Transmisión O-Ring';
UPDATE productos SET imagen = '/img/productos/bateria-gel.jpg'         WHERE nombre = 'Batería de Gel 12V';
